...
open a [bug report](https://github.com/ustcme/HyperStreamLineVis/issues). In theory, the build scripts should also work on other
...
When [reporting a bug](https://github.com/ustcme/HyperStreamLineVis/issues), please also attach the logfile generated by LineVis.
